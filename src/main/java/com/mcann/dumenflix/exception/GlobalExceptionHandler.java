...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(DumenFlixApplicationException.class)
	@ResponseBody
	public ResponseEntity<ErrorMessage> xApplicationExceptionHandler(DumenFlixApplicationException exception){
